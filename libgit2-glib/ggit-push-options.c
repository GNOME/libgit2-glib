 ...
 *
 * Returns: (transfer full) (nullable): a #GgitPushOptions or %NULL.
 *
 **/
GgitPushOptions *
 ...
 *
 * Set the remote callbacks for the push options (needed for authentication etc..  as remote is not called.)
 *
 **/
void
 ...
 *
 * Returns: the #GgitRemoteCallbacks
 *
 **/
GgitRemoteCallbacks*

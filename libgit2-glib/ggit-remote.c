 ...
 *
 * Returns: (transfer none) (allow-none): the remote oid or %NULL.
 */
GgitOId *
 ...
 *
 * Returns: (transfer none) (allow-none): the local oid or %NULL.
 */
GgitOId *
 ...
 *
 * Returns: (transfer none) (allow-none): the remote head name or %NULL.
 */
const gchar *
 ...
 *
 * Returns: (transfer full) (allow-none): a newly allocated #GgitRemote or %NULL.
 */
GgitRemote *
 ...
 *
 * Returns: (transfer full) (allow-none): the repository where the remote resides or %NULL.
 */
GgitRepository *
 ...
 *
 * Returns: (transfer none) (allow-none): the name of @remote or %NULL.
 */
const gchar *
 ...
 *
 * Returns: (transfer none) (allow-none): the url of @remote or %NULL.
 */
const gchar *
 ...
 *
 * Returns: (transfer full) (allow-none): a list of fetch refspecs or %NULL.
 */
gchar **
 ...
 *
 * Returns: (transfer full) (allow-none): a list of push refspecs or %NULL.
 */
gchar **
 ...
 *
 * Returns: (array zero-terminated=1) (allow-none): the remote heads or %NULL.
 */
GgitRemoteHead **

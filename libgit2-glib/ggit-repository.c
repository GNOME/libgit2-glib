                       ...
                       GError                **error)
{
	...
	their_heads_native = g_new0 (git_commit *, their_heads_length);

	for (i = 0; i < their_heads_length; ++i)
	{
		their_heads_native[i] = _ggit_native_get (their_heads[i]);
	}

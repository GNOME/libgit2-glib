 ...
 *
 * Returns: (transfer full) (allow-none): The rebase operation or %NULL if @idx was out of bounds.
 */
GgitRebaseOperation *
 ...
 *
 * Returns: (transfer full) (allow-none): the rebase operation that is to be performed next or %NULL.
 */
GgitRebaseOperation *
 ...
 * invocation.
 *
 * Returns: (transfer full) (allow-none): a #GgitOId of the newly created commit or %NULL.
 */
GgitOId *

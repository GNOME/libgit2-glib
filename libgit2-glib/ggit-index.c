 ...
 *
 * Returns: (transfer full) (nullable): a #GgitIndex or %NULL if an error occurred.
 *
 **/
GgitIndex *
 ...
 *
 * Returns: (transfer full) (nullable): a #GgitIndexEntries or %NULL.
 *
 **/
GgitIndexEntries *
 ...
 *
 * Returns: (transfer full) (nullable): a #GgitIndexEntriesResolveUndo or %NULL.
 *
 **/
 ...
 *
 * Returns: (transfer full) (nullable): the #GgitRepository that owns this index or %NULL.
 *
 **/
GgitRepository *
 ...
 *
 * Returns: (transfer full) (nullable): a #GgitOId or %NULL in case of an error.
 *
 **/
GgitOId *

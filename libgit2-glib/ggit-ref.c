 ...
 * not a symbolic one).
 *
 * Returns: (transfer full) (allow-none): a new oid if available, %NULL otherwise.
 */
GgitOId *
 ...
 *
 * Returns: (transfer none) (allow-none): the name if available, %NULL otherwise.
 */
const gchar *
 ...
 *
 * Returns: (transfer none) (allow-none): the full name of a reference or %NULL.
 */
const gchar *
 ...
 *
 * Returns: (transfer none) (allow-none): the shorthand name of a reference or %NULL.
 */
const gchar *
 ...
 *
 * Returns: (transfer none) (allow-none): a string representation of the ref or %NULL.
 *
 **/
const gchar *
 ...
 *
 * Returns: (transfer full) (allow-none): the resolved reference to the peeled one or %NULL.
 */
GgitRef *
 ...
 *
 * Returns: (transfer full) (allow-none): the repository where a reference resides or %NULL.
 */
GgitRepository *
 ...
 *
 * Returns: (transfer full) (allow-none): the newly created #GgitRef or %NULL.
 */
GgitRef *
 ...
 *
 * Returns: (transfer full) (allow-none): a newly created #GgitRef or %NULL.
 */
GgitRef *
 ...
 *
 * Returns: (transfer full) (allow-none): a #GgitObject or %NULL.
 *
 **/
GgitObject *
 ...
 * yet.
 *
 * Returns: (transfer full) (allow-none): the reflog or %NULL.
 */
GgitReflog *

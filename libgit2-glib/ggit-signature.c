 ...
 *
 * Returns: (transfer full) (allow-none): a newly allocated #GgitSignature or %NULL.
 */
GgitSignature *
 ...
 *
 * Returns: (transfer full) (allow-none): a #GgitSignature or %NULL.
 *
 **/
GgitSignature *
 ...
 *
 * Returns: (transfer none) (allow-none): the name of the person or %NULL.
 */
const gchar *
 ...
 *
 * Returns: (transfer none) (allow-none): the email of the person or %NULL.
 */
const gchar *
 ...
 *
 * Returns: (transfer full) (allow-none): the time when the action happened or %NULL.
 */
GDateTime *
 ...
 *
 * Returns: (transfer full) (allow-none): the timezone in which the action happened or %NULL.
 */
GTimeZone *

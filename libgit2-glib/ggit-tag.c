 ...
 *
 * Returns: (transfer full) (allow-none): the target #GgitObject of the tag or %NULL.
 */
GgitObject *
 ...
 *
 * Returns: (transfer full) (allow-none): the target #GgitOId of the tag or %NULL.
 */
GgitOId *
 ...
 *
 * Returns: (transfer none) (allow-none): the name of the tag or %NULL.
 */
const gchar *
 ...
 * g_object_unref().
 *
 * Returns: (transfer full) (allow-none): the tagger (author) of the tag or %NULL.
 */
GgitSignature *
 ...
 *
 * Returns: (transfer none) (allow-none): the message of the tag or %NULL.
 */
const gchar *

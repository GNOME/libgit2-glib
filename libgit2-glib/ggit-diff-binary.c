 ...
 *
 * Returns: (transfer none) (allow-none): a #GgitDiffBinary or %NULL.
 **/
GgitDiffBinary *
 ...
 *
 * Returns: (transfer none) (allow-none): the contents of the old file or %NULL.
 */
GgitDiffBinaryFile *
 ...
 *
 * Returns: (transfer none) (allow-none): the contents of the new file or %NULL.
 */
GgitDiffBinaryFile *

 ...
 *
 * Returns: (transfer full) (allow-none): a newly allocated #GgitDiff if
 ...
 *
 * Returns: (transfer full) (allow-none): the patch or %NULL if an error occurred.
 *
 **/
gchar *
 ...
 *
 * Returns: (transfer full) (allow-none): a #GgitDiffDelta or %NULL.
 *
 **/
GgitDiffDelta *

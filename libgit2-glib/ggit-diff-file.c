 ...
 *
 * Returns: (transfer none) (allow-none): a #GgitDiffFile or %NULL.
 **/
GgitDiffFile *
 ...
 *
 * Returns: (transfer none) (allow-none): the file's #GgitOId or %NULL.
 */
GgitOId *
 ...
 *
 * Returns: (transfer none) (allow-none): the file's path, or %NULL.
 */
const gchar *

 ...
 *
 * Returns: (transfer full) (allow-none): the #GGitTreeEntry or %NULL if no such entry exists.
 *
 */
GgitTreeEntry *
 ...
 *
 * Returns: (transfer full) (allow-none): the #GgitOId of the created tree object or %NULL.
 *
 **/
GgitOId *
 ...
 *
 * Returns: (transfer full) (allow-none): a #GgitTreeEntry or %NULL.
 *
 **/
GgitTreeEntry *

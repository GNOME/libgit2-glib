 ...
 *
 * Returns: (transfer none) (allow-none): a #GgitDiffDelta or %NULL.
 **/
GgitDiffDelta *
 ...
 *
 * Returns: (transfer none) (allow-none): the delta's old file or %NULL.
 */
GgitDiffFile *
 ...
 *
 * Returns: (transfer none) (allow-none): the delta's new file or %NULL.
 */
GgitDiffFile *
